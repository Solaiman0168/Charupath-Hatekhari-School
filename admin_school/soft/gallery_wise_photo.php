            ...
            $photo_gallery_id = $_POST['photo_gallery_id'];
             $bn_image_title = $_POST['bn_image_title'];
                ...
                if ($_FILES["image_url"]["error"] > 0) {
                   ...
                   $sql = "INSERT INTO $tbl_name SET `photo_gallery_id` ='$photo_gallery_id' , `image_url` = '$image_url',`bn_image_title` ='$bn_image_title' , `created_by`='$user_no', `created_on`='$CURR_TIME'";
                            $result = mysqli_query($con,$sql);
                            if($result)
                            {
    ...
    if(isset($_POST['update']))
    {
            ...
            $gallery_wise_photo_id =$_POST['gallery_wise_photo_id'];
                 ...
                 if ($_FILES["image_url"]["error"] > 0) {
                  ...
                  $sql = "UPDATE $tbl_name SET `photo_gallery_id` ='$photo_gallery_id' ,  `image_url` = '$image_url' , `bn_image_title` ='$bn_image_title' ,`is_updated` = 1, `updated_by` = '$user_no' ,`updated_on` = '$CURR_TIME' WHERE `gallery_wise_photo_id` = '$gallery_wise_photo_id'";
                $result = mysqli_query($con,$sql);
                if($result)
                {
