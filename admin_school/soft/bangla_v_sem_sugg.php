...
<?php $table_heading = "Semester Suggestion Bangla Version";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
   
<?php
        $tbl_name="suggestion_term_exam_bangla";       //your table name
        $targetpage = "bangla_v_sem_sugg.php";   //your file name  (the name of this file)
