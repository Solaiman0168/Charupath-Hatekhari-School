...
<?php $table_heading = "সভাপতির বক্তব্য";?>
...
<?php
    ...
    if(isset($_POST['update']))
    {
        ...
        $sql = "UPDATE $tbl_name SET `bn_title` = '$bn_title' ,`bn_founder_name` = '$bn_founder_name' ,`bn_founder_designation` = '$bn_founder_designation' ,`bn_short_speech` = '$bn_short_speech' ,`bn_speech`='$bn_short_speech', `image_url` = '$image_url',`is_updated` = 1, `updated_by` = $user_no ,`updated_on` = '$CURR_TIME' WHERE founder_speech_id = 1";
