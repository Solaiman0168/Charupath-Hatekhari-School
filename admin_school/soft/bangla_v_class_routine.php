...
<?php $table_heading = "ক্লাস রুটিন (বাংলা ভার্সন)";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
   
<?php
        $tbl_name="routine_bangla";       //your table name
        $targetpage = "bangla_v_class_routine.php";   //your file name  (the name of this file)
