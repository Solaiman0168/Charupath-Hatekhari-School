...
<?php $table_heading = "এক্সাম রুটিন (ইংরেজী ভার্সন)";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
   
<?php
        $tbl_name="exam_routine_english";       //your table name
        $targetpage = "english_v_exam_routine.php";   //your file name  (the name of this file)
    ...
    {
        $ID = $_GET['delete'];
        $sql = "UPDATE $tbl_name SET `is_deleted` = 1 ,`deleted_by` = '$user_no', `deleted_on` = '$CURR_TIME' WHERE routine_id = $ID";
...
?>
     ...
     <form class="cmxform form-horizontal " id="signupForm" method="post" action="" enctype="multipart/form-data">
        ...
        <div class="form-group ">
            <label for="title" class="control-label col-lg-3">রুটিন</label>
            <div class="col-lg-4">
...
?>
    ...
    <?php $i=$page*$limit-$limit+1; while($row = mysqli_fetch_array($result)):?>
        <tr>
            ...
            <td>
                <a onclick="return confirm('Are you Sure Want to Delete?');" href="<?=$targetpage.'?delete='.$row['routine_id']?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                </td>
        </tr>
    <?php endwhile;?>
    </table>
