...
<?php $table_heading = "শিক্ষক/শিক্ষিকা(ইংরেজী ভার্সন)";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
   
<?php
        $tbl_name="teacher_english_version";       //your table name
        $targetpage = "teacher_english_version.php";   //your file name  (the name of this file)
