...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2018 at 06:20 AM
...
CREATE TABLE IF NOT EXISTS `brief_seats` (
...
CREATE TABLE IF NOT EXISTS `death_committee_member` (
...
CREATE TABLE IF NOT EXISTS `footer_info_details` (
...
CREATE TABLE IF NOT EXISTS `founder_speech` (
...
CREATE TABLE IF NOT EXISTS `gallery_wise_photo` (
...
CREATE TABLE IF NOT EXISTS `home_about_us1` (
...
CREATE TABLE IF NOT EXISTS `home_about_us2` (
...
CREATE TABLE IF NOT EXISTS `home_about_us3` (
...
CREATE TABLE IF NOT EXISTS `home_about_us4` (
...
CREATE TABLE IF NOT EXISTS `home_about_us5` (
...
CREATE TABLE IF NOT EXISTS `home_about_us6` (
...
CREATE TABLE IF NOT EXISTS `home_about_us7` (
...
CREATE TABLE IF NOT EXISTS `home_about_us8` (
...
CREATE TABLE IF NOT EXISTS `home_admission_paper` (
...
CREATE TABLE IF NOT EXISTS `home_admission_process` (
...
CREATE TABLE IF NOT EXISTS `home_admission_rule` (
...
CREATE TABLE IF NOT EXISTS `home_admission_uniform` (
...
CREATE TABLE IF NOT EXISTS `home_events_details` (
...
CREATE TABLE IF NOT EXISTS `home_heading1` (
...
CREATE TABLE IF NOT EXISTS `home_heading2` (
...
CREATE TABLE IF NOT EXISTS `home_heading3` (
...
CREATE TABLE IF NOT EXISTS `home_heading4` (
...
CREATE TABLE IF NOT EXISTS `home_heading5` (
...
CREATE TABLE IF NOT EXISTS `home_important_links` (
...
CREATE TABLE IF NOT EXISTS `home_result` (
...
CREATE TABLE IF NOT EXISTS `home_why_we` (
...
CREATE TABLE IF NOT EXISTS `joke1` (
...
CREATE TABLE IF NOT EXISTS `notice_setup` (
...
(14, 'vbuhjhk', 'ibunhjjk', '2017-11-17', '1510250083windows-8 DIU.jpg', '1510250083farah.png', 1, '2017-11-04 00:00:00', 0, 0, '0000-00-00 00:00:00', 1, 1, '2017-11-09 00:00:00'),
(15, 'ygiuhjo', 'bun', '2017-11-07', '1510250124Lab-report-1.docx', 'No Notice Uploaded', 1, '2017-11-04 00:00:00', 1, 1, '2017-11-09 00:00:00', 1, 1, '2017-11-09 00:00:00'),
(16, 'vbn', 'hkb jnklm', '2017-11-02', '15102501900-04-06-26377e73561d26e4824b5ee31b7a8a6a0969de876b24a9fd749274071a6d57f5_400.jpg', 'No Notice Uploaded', 1, '2017-11-04 00:00:00', 1, 1, '2017-11-09 00:00:00', 1, 1, '2017-11-09 00:00:00'),
(17, 'ftyt', 'fghg', '2017-11-15', '1510250476Agreement of lulu1.pdf', '1510250476Logos.jpg', 1, '2017-11-09 00:00:00', 0, 0, '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00');
...
CREATE TABLE IF NOT EXISTS `present_committee_member` (
...
CREATE TABLE IF NOT EXISTS `previous_committee_member` (
...
CREATE TABLE IF NOT EXISTS `principal_speech` (
...
CREATE TABLE IF NOT EXISTS `scholar_student` (
...
CREATE TABLE IF NOT EXISTS `short_story1` (
...
CREATE TABLE IF NOT EXISTS `teacher_day_shift` (
...
CREATE TABLE IF NOT EXISTS `teacher_death` (
...
CREATE TABLE IF NOT EXISTS `teacher_morning_shift` (
...
CREATE TABLE IF NOT EXISTS `teacher_previous` (
...
CREATE TABLE IF NOT EXISTS `teacher_vocational` (
...
CREATE TABLE IF NOT EXISTS `why_we_img` (
`logo_id` int(11) NOT NULL,
  `image_url` varchar(255) NOT NULL,
  `created_by` int(11) NOT NULL,
  `created_on` datetime NOT NULL,
...
ALTER TABLE `gallery_wise_photo`
 ADD PRIMARY KEY (`gallery_wise_photo_id`), ADD KEY `photo_gallery_id` (`photo_gallery_id`);
...
ALTER TABLE `xxx_user`
 ADD PRIMARY KEY (`USER_NO`), ADD UNIQUE KEY `USER_NAME` (`USER_NAME`), ADD UNIQUE KEY `USER_FULL_NAME` (`USER_FULL_NAME`), ADD UNIQUE KEY `USER_EMAIL` (`USER_EMAIL`), ADD UNIQUE KEY `USER_NO` (`USER_NO`), ADD UNIQUE KEY `USER_NO_2` (`USER_NO`);
