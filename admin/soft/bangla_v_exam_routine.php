...
<?php $table_heading = "এক্সাম রুটিন (বাংলা ভার্সন)";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
   
<?php
        $tbl_name="exam_routine_bangla";       //your table name
        $targetpage = "bangla_v_exam_routine.php";   //your file name  (the name of this file)
