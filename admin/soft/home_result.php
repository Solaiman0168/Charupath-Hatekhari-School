...
<?php $table_heading = "Results in Charupath";?>
...
<?php
    ...
    {   
            ...
            $bn_rate_pass =$_POST['bn_rate_pass'];
                ...
                $SQL = "SELECT * FROM $tbl_name WHERE `is_deleted` = 0 AND `bn_exam_name` = '$bn_exam_name'  AND `bn_year` = '$bn_year' AND `bn_a_plus` = '$bn_a_plus'AND `bn_a` = '$bn_a' AND `bn_a_minus` = '$bn_a_minus' AND `bn_f` = '$bn_f' AND  `bn_rate_pass` = 'bn_rate_pass'";

                $COUNT = mysqli_num_rows(mysqli_query($con,$SQL));
                    
                    if($COUNT < 1):  
                  $sql = "INSERT INTO $tbl_name SET `bn_exam_name` = '$bn_exam_name', `bn_year` ='$bn_year' ,  `bn_a_plus` = '$bn_a_plus' ,`bn_a` = '$bn_a' ,`bn_a_minus` = '$bn_a_minus' ,`bn_f` = '$bn_f' , `bn_rate_pass` = '$bn_rate_pass'";
                            $result = mysqli_query($con,$sql);
                            if($result)
                            {
    ...
    if(isset($_POST['update']))
    {
       ...
       $SQL = "SELECT * FROM $tbl_name WHERE `is_deleted` = 0 AND `bn_exam_name` = '$bn_exam_name' AND `bn_year` ='$bn_year' AND `bn_a_plus` = '$bn_a_plus' AND `bn_a` = '$bn_a' AND `bn_a_minus` = '$bn_a_minus' AND `bn_f` = '$bn_f' AND `bn_rate_pass` = 'bn_rate_pass' AND `home_result_id` != '$home_result_id'";

            $COUNT = mysqli_num_rows(mysqli_query($con,$SQL));
            if($COUNT < 1): 
         
            $sql = "UPDATE $tbl_name SET `bn_exam_name` = '$bn_exam_name', `bn_year` ='$bn_year', `bn_a_plus` = '$bn_a_plus' ,`bn_a` = '$bn_a' ,`bn_a_minus` = '$bn_a_minus' ,`bn_f` = '$bn_f' , `bn_rate_pass` = '$bn_rate_pass' ,  WHERE `home_result_id` = '$home_result_id'";
                $result = mysqli_query($con,$sql);
                if($result)
                {
