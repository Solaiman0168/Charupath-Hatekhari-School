...
<?php
    ...
    if(isset($_POST['submit']))
    {
            $bn_title = trim($_POST['bn_title']);
                 ...
                 $SQL = "SELECT * FROM $tbl_name WHERE `is_deleted` = 0 AND `bn_title` ='$bn_title'  ";
                   ...
                   $sql = "INSERT INTO $tbl_name SET `bn_title` ='$bn_title' ,  `icon_url` = '$icon_url', `created_by`='$user_no', `created_on`='$CURR_TIME'";
                            $result = mysqli_query($con,$sql);
                            if($result)
                            {
    ...
    if(isset($_POST['update']))
    {
        ...
        $SQL = "SELECT * FROM $tbl_name WHERE `is_deleted` = 0 AND `bn_title` ='$bn_title'  AND `photo_gallery_id` != '$photo_gallery_id'";
            ...
            if($COUNT < 1): 
                if ($_FILES["icon_url"]["error"] > 0) {
                  ...
                  $sql = "UPDATE $tbl_name SET `bn_title` ='$bn_title' ,  `icon_url` = '$icon_url' , `is_updated` = 1, `updated_by` = '$user_no' ,`updated_on` = '$CURR_TIME' WHERE `photo_gallery_id` = '$photo_gallery_id'";
                $result = mysqli_query($con,$sql);
                if($result)
                {
