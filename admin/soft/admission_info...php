...
<?php $table_heading = "নির্দেশনা";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
   
<?php
        $tbl_name="instruction_news";       //your table name
        $targetpage = "admission_news.php";   //your file name  (the name of this file)
    ...
    {
        $ID = $_GET['delete'];
        $sql = "UPDATE $tbl_name SET `is_deleted` = 1 ,`deleted_by` = '$user_no', `deleted_on` = '$CURR_TIME' WHERE instruction_news_no = $ID";
...
?>
     ...
     <form class="cmxform form-horizontal " id="signupForm" method="post" action="" enctype="multipart/form-data">
        ...
        <div class="form-group ">
            <label for="title" class="control-label col-lg-3">নির্দেশনা </label>
            <div class="col-lg-4">
...
?>
    ...
    <?php $i=$page*$limit-$limit+1; while($row = mysqli_fetch_array($result)):?>
        <tr>
            ...
            <td>
                <a onclick="return confirm('Are you Sure Want to Delete?');" href="<?=$targetpage.'?delete='.$row['instruction_news_no']?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                </td>
        </tr>
    <?php endwhile;?>
    </table>
