...
<?php $table_heading = "প্রধান শিক্ষকের বক্তব্য";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
   
<?php
        $tbl_name="principal_speech";       //your table name
        $targetpage = "home_principal_speech.php";   //your file name  (the name of this file)
    ...
    if(isset($_POST['update']))
    {
           ...
           $sql = "UPDATE $tbl_name SET `bn_title` = '$bn_title' ,`bn_principal_name` = '$bn_principal_name' ,`bn_principal_designation` = '$bn_principal_designation' ,`bn_short_speech` = '$bn_short_speech' ,`bn_speech`='$bn_short_speech',`image_url` = '$image_url',`is_updated` = 1, `updated_by` = $user_no ,`updated_on` = '$CURR_TIME' WHERE principal_speech_id = 1";
