...
<?php $table_heading = "Teachers Information";?>
<?php include 'include/sidebar.php';?>
<?php include 'include/body-top.php';?>
  
<?php
        $tbl_name="teachers_information";       //your table name
        $targetpage = "teachers_information.php";   //your file name  (the name of this file)
    ...
    {
        $ID = $_GET['delete'];
        $sql = "UPDATE $tbl_name SET `is_deleted` = 1 ,`deleted_by` = '$user_no', `deleted_on` = '$CURR_TIME' WHERE teachers_information_id = $ID";
    ...
    if(isset($_POST['submit']))
    {
            ...
            $bn_speech = trim($_POST['bn_speech']);
                 ...
                 $SQL = "SELECT * FROM $tbl_name WHERE `is_deleted` = 0 AND `bn_name` ='$bn_name'  AND `bn_designation` = '$bn_designation' AND `bn_mobile` = '$bn_mobile'AND `email` = '$email'AND `bn_degree` = '$bn_degree' AND `bn_dob` ='$bn_dob'  AND `bn_job_duration` = '$bn_job_duration'AND `bn_present_address` = '$bn_present_address'AND `bn_permanent_address` = '$bn_permanent_address'AND `bn_speech_title` = '$bn_speech_title'AND `bn_speech` = '$bn_speech'";
                   ...
                   $sql = "INSERT INTO $tbl_name SET `bn_name` ='$bn_name'  , `bn_designation` = '$bn_designation' , `bn_mobile` = '$bn_mobile',`email` = '$email', `bn_degree` = '$bn_degree' , `bn_dob` ='$bn_dob' , `bn_job_duration` = '$bn_job_duration', `bn_present_address` = '$bn_present_address', `bn_permanent_address` = '$bn_permanent_address',`bn_speech_title` = '$bn_speech_title', `bn_speech` = '$bn_speech', `image_url` = '$image_url', `created_by`='$user_no', `created_on`='$CURR_TIME'";
                            $result = mysqli_query($con,$sql);
                            if($result)
                            {
    ...
    if(isset($_POST['update']))
    {
            ...
            $teachers_information_id = $_POST['teachers_information_id'];
            $bn_designation =trim( $_POST['bn_designation']);
        ...
        $SQL = "SELECT * FROM $tbl_name WHERE `is_deleted` = 0 AND `bn_name` ='$bn_name'  AND `bn_designation` = '$bn_designation' AND `bn_mobile` = '$bn_mobile'AND `email` = '$email'AND `bn_degree` = '$bn_degree' AND `bn_dob` ='$bn_dob'  AND `bn_job_duration` = '$bn_job_duration'AND `bn_present_address` = '$bn_present_address'AND `bn_permanent_address` = '$bn_permanent_address'AND `bn_speech_title` = '$bn_speech_title'AND `bn_speech` = '$bn_speech' AND `teachers_information_id` != '$teachers_information_id'";
            ...
            if($COUNT < 1): 
                if ($_FILES["image_url"]["error"] > 0) {
                  ...
                  $sql = "UPDATE $tbl_name SET `bn_name` ='$bn_name'  , `bn_designation` = '$bn_designation' , `bn_mobile` = '$bn_mobile',`email` = '$email', `bn_degree` = '$bn_degree' , `bn_dob` ='$bn_dob' , `bn_job_duration` = '$bn_job_duration', `bn_present_address` = '$bn_present_address', `bn_permanent_address` = '$bn_permanent_address',`bn_speech_title` = '$bn_speech_title', `bn_speech` = '$bn_speech' ,`image_url` = '$image_url' , `is_updated` = 1, `updated_by` = '$user_no' ,`updated_on` = '$CURR_TIME' WHERE `teachers_information_id` = '$teachers_information_id'";
                $result = mysqli_query($con,$sql);
                if($result)
                {
...
?>
    ...
    <?php
        if(isset($_GET['edit'])):
        $id = $_GET['edit'];
        $sql = "SELECT * FROM $tbl_name WHERE `teachers_information_id` = '$id' ";
    ...
    ?>
     ...
     <div class="form-group " <?php if($mgs=='')echo "style='display:none;'" ?>>
            ...
            <div>
                <input type="hidden" name="teachers_information_id" value="<?=$result['teachers_information_id']?>" />
            </div>
        </div>
      ...
      <div class="form-group ">
        ...
        <div class="form-group ">
            ...
            <div class="col-lg-8">
                <input class=" form-control" id="" name="bn_designation" type="text" value="<?=$result['bn_designation']?>"  />
            </div>
        ...
        <div class="form-group ">
            ...
            <div class="col-lg-8">
                <input class=" form-control" id="" name="bn_mobile" type="text" value="<?=$result['bn_mobile']?>"  />
            </div>
        ...
        <div class="form-group ">
            ...
            <div class="col-lg-8">
                <input class=" form-control" id="" name="email" type="text" value="<?=$result['email']?>"  />
            </div>
        </div>
        ...
        <div class="form-group ">
            ...
            <div class="col-lg-8">
                <input class=" form-control" id="" name="bn_degree" type="text" value="<?=$result['bn_degree']?>" />
            </div>
         ...
         <div class="form-group ">
            ...
            <div class="col-lg-8">
                <input class=" form-control" id="" name="bn_dob" type="date" value="<?=$result['bn_dob']?>"  />
            </div>
        ...
        <div class="form-group ">
            ...
            <div class="col-lg-8">
                <input class=" form-control" id="" name="bn_job_duration" type="text" value="<?=$result['bn_job_duration']?>"  />
            </div>
        ...
        <div class="form-group ">
            ...
            <div class="col-lg-8">
                <input class=" form-control" id="" name="bn_present_address" type="text" value="<?=$result['bn_present_address']?>" />
            </div>
        ...
        <div class="form-group ">
            ...
            <div class="col-lg-8">
                <input class=" form-control" id="" name="bn_permanent_address" type="text" value="<?=$result['bn_permanent_address']?>"  />
            </div>
        ...
        <div class="form-group ">
            ...
            <div class="col-lg-8">
                <input class=" form-control" id="" name="bn_speech_title" type="text" value="<?=$result['bn_speech_title']?>"  />
            </div>
        ...
        <div class="form-group ">
            ...
            <div class="col-lg-8">
                <textarea  class=" form-control" id="" name="bn_speech" type="text"><?=$result['bn_speech']?></textarea>
       ...
       <div class="form-group ">
        ...
        <div class="form-group ">
         ...
         <div class="form-group ">
            ...
            <div class="col-lg-8">
                <input class=" form-control" id="" name="bn_dob" type="date" required />
            </div>
    ...
    <div style="overflow: auto">
        ...
        <?php $i=$page*$limit-$limit+1; while($row = mysqli_fetch_array($result)):?>
            <tr>
                ...
                <td>
                    <a onclick="return confirm('Are you Sure Want to Edit?');" href="<?=$targetpage.'?edit='.$row['teachers_information_id']?>" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                    <a onclick="return confirm('Are you Sure Want to Delete?');" href="<?=$targetpage.'?delete='.$row['teachers_information_id']?>" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                </td>
            </tr>
        <?php endwhile;?>
        </table>
