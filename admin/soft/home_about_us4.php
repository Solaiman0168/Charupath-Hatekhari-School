...
<?php
    ...
    if(isset($_POST['update']))
    {
         ...
         $sql = "UPDATE $tbl_name SET `bn_title` = '$bn_title' ,`bn_short_details` ='$bn_short_details',`bn_speech` ='$bn_short_details',`is_updated` = 1, `updated_by` = $user_no ,`updated_on` = '$CURR_TIME' WHERE `home_about_us4_id` = 1";
